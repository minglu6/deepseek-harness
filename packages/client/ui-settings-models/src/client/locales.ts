...
export const en = {
  ...
  vpcInstance: 'VPC instance',
  vpcInstancePlaceholder: 'Public cloud',
  vpcInstanceHint: 'Optional. Enterprise host such as tenant.vpc.qoder.com.cn. Leave blank for public cloud.',
  models: 'Models',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  vpcInstance: 'VPC 实例',
  vpcInstancePlaceholder: '公有云',
  vpcInstanceHint: '可选。企业主机，例如 tenant.vpc.qoder.com.cn。留空使用公有云。',
  models: '模型目录',
